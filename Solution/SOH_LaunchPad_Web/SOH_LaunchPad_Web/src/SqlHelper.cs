...
namespace Helper
{
    ...
    public sealed class SqlHelper
    {
        ...
        public static string GetConnection(string name)
        {
            ...
            if (setting != null)
            {
                connect = DeCryptionConnectString(setting.ConnectionString);
            }

            return connect;
        }

        public static string DeCryptionConnectString(string connectString)
        {
            Commons.Crypto crypto = new Commons.Crypto();

            SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder(connectString);

            builder.UserID = crypto.Decry(builder.UserID);

            builder.Password = crypto.Decry(builder.Password);
        ...
        public static int ExecuteNonQuery(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            SqlTransaction traSql = connection.BeginTransaction();
            // Create a command and prepare it for execution
            SqlCommand cmd = new SqlCommand();
            // add by seven begin
            cmd.CommandTimeout = 0;
            // add by seven end
            cmd.Transaction = traSql;
        ...
        internal sealed class SqlHelperParameterCache
        {
            ...
            public static void AssignParameterValues(SqlParameter[] commandParameters, object[] parameterValues)
            {
                ...
                if (commandParameters.Length > parameterValues.Length)
                {
                    ...
                    for (int i = 0, j = commandParameters.Length - parameterValues.Length; i < j; i++)
                    {
                        commandParameters[i].Value = DBNull.Value;
                    }
                }
            ...
            /// <param name="commandParameters">Array of SqlParameters to be assigned values</param>
            /// <param name="parameterValues">Array of objects holding the values to be assigned</param>
            public static void AssignParameterValues(SqlParameter[] commandParameters, Dictionary<string, object> parameterValues)
            {
                if ((commandParameters == null) || (parameterValues == null))
                {
                    // Do nothing if we get no data
                ...
                {
                    // If the current array value derives from IDbDataParameter, then assign its Value property
                    String paraName = commandParameters[i].ParameterName;
                    if (parameterValues.ContainsKey(paraName))
                    {
                        if (parameterValues[paraName] is IDbDataParameter)
                        {
                            IDbDataParameter paramInstance = (IDbDataParameter)parameterValues[paraName];
                            if (paramInstance.Value == null)
                            {
                                commandParameters[i].Value = DBNull.Value;
                            }
                        ...
                        else if (parameterValues[paraName] == null)
                        {
                            commandParameters[i].Value = DBNull.Value;
                        }
                        else
                        {
                            commandParameters[i].Value = parameterValues[paraName];
                        }
                    }
                    else
                    {
            ...
            /// <param name="commandParameters">Array of SqlParameters to be assigned values</param>
            /// <param name="parameterValues">Array of objects holding the values to be assigned</param>
            public static void UpdateParameterValues(SqlParameter[] commandParameters, object[] parameterValues)
            {
                if ((commandParameters == null) || (parameterValues == null))
                {
                    // Do nothing if we get no data
            ...
            /// <param name="commandParameters">Array of SqlParameters to be assigned values</param>
            /// <param name="parameterValues">Array of objects holding the values to be assigned</param>
            public static void UpdateParameterValues(SqlParameter[] commandParameters, Dictionary<string, object> parameterValues)
            {
                if ((commandParameters == null) || (parameterValues == null))
                {
                    // Do nothing if we get no data
                ...
                for (int i = 0, j = commandParameters.Length; i < j; i++)
                {
                    ...
                    if (parameterValues.ContainsKey(paraName))
                    {
                        if (commandParameters[i].Direction == ParameterDirection.ReturnValue)
                        {
                            parameterValues[paraName] = commandParameters[i].Value;
                        }
                    ...
                    else
                    {
                        if (commandParameters[i].Direction == ParameterDirection.ReturnValue)
                        {
                            parameterValues.Add(paraName, commandParameters[i].Value);
                        }
            ...
            /// <summary>
            /// This method check assigns an array of values to an array of SqlParameters
            /// </summary>
            /// <param name="commandParameters">Array of SqlParameters to be assigned values</param>
            /// <param name="parameterValues">Array of objects holding the values to be assigned</param>
            public static String CheckParameterValues(SqlParameter[] commandParameters, object[] parameterValues)
            {
            ...
            /// <param name="commandParameters">Array of SqlParameters to be assigned values</param>
            /// <param name="parameterValues">Array of objects holding the values to be assigned</param>
            public static String CheckParameterValues(SqlParameter[] commandParameters, Dictionary<string, object> parameterValues)
            {
                if ((commandParameters == null) || (parameterValues == null))
                {
                    // Do nothing if we get no data
