...
function Start() {
    ...
    function GetResultGridColumnsDetail()
    {
        ...
        schema = [
            ...
            { field: "HAN_STI_SAM", title: "Hand Stitch \nSAM/DZ", width: "100px"},
            { field: "KNI_TRI_SAM", title: "Knitting Trim \nSAM/DZ", width: "100px"},
            { field: "FIN_SAM", title: "Finishing \nSAM/DZ", width: "100px"},
            { field: "FIN_OTH_SAM", title: "Finish Oth \nSAM/DZ", width: "100px"},
            { field: "KNI_SAM_COST", title: "Knitting SAM \nCost", width: "100px"},
            { field: "SUB_LIN_COST", title: "Subcon Linking \nCost", width: "100px"},
            { field: "SUB_FIN_COST", title: "Subcon Finish \nCost", width: "100px"},
            { field: "KNI_TRI_COST", title: "Knit Trim SAM \nCost", width: "100px"},
            { field: "LIN_SAM_COST", title: "Linking SAM \nCost", width: "100px"},
            { field: "SEW_SAM_COST", title: "Sewing SAM \nCost", width: "100px"},
            { field: "HS_SAM_COST", title: "Hand Stitch \nSAM Cost", width: "100px"},
            { field: "FIN_SAM_COST", title: "Finishing SAM \nCost", width: "100px"},
            { field: "FIN_OTH_COST", title: "Finish Oth \nSAM Cost", width: "100px"},
            { field: "FTY_SUB", title: "Factory \nSubsidy", width: "100px"},
