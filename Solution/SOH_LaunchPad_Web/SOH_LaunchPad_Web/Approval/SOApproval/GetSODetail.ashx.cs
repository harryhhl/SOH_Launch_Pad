...
{
    /// <summary>
    /// Summary description for GetSODetail
    /// </summary>
    public class GetSODetail : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            if(sid.Length > 0)
            {
                string detailJson = HttpContext.Current.Session["SOApprovalDetail_" + sid] as string;
